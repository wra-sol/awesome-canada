...
- Priority categories deepened: `planning-zoning` (56), `council` (61), `lobbyist` (14), `heritage` registers (14), `health-region` (24), `transit` GTFS (57), `weather` (11), `budget` (44), `school-board` (37), `open-data` (152), `environment` (26)
