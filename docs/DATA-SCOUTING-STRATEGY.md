...
- Priority categories deepened: `planning-zoning` (53), `council` (60), `lobbyist` (14), `heritage` registers (14), `health-region` (24), `transit` GTFS (57), `weather` (11), `budget` (43), `school-board` (37), `open-data` (152), `environment` (26)
