...
- Priority categories deepened: `planning-zoning` (58), `council` (64), `lobbyist` (14), `heritage` registers (14), `health-region` (24), `transit` GTFS (57), `weather` (11), `budget` (49), `school-board` (37), `open-data` (152), `environment` (26)
...
- **2026-07-01:** Added **5** gap-fill entries across Nova Scotia, Saskatchewan, and PEI. CBRM — Budget and Financial Documents (first CBRM budget entry; direct PDF downloads of operating budgets, annual reports, and consolidated financial statements 2022–2026), North Battleford — Budget Documents (first North Battleford entry; approved budgets 2018–2026 plus 2025–2029 strategic plan), Estevan — Council Agendas & Minutes (first Estevan entry; downloadable PDF agendas and minutes for regular council meetings), Stratford — Town Council Expenses (first Stratford entry; annual PDF expense claims 2016–2025), and Moose Jaw — Financial & Budget Reports (depth beyond Questica OpenBook; annual budgets 2023–2025 plus quarterly financial reports). New discovery: WordPress-powered municipal sites (CBRM, Moose Jaw, Estevan) often publish budget and council PDFs under predictable paths — enumerate via `/wp-json/wp/v2/pages` when available; Umbraco/uSkinned sites (North Battleford) may host budget PDFs under `/our-city-government/budgets-and-finances/` with direct PDF links. Updated `scripts/categories.js` to add `North Battleford`, `Estevan`, and `Stratford` jurisdictions. Total now 949 resources. Validation passes.
