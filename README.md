...
**Quick stats:** 1023 resources · 35 categories · covering Federal, Provincial, Territorial, Regional and Municipal governments.
...
- [🏗️ Planning, Zoning & Development](#planning-zoning-and-development) — 68
- [🏛️ Council, Democracy & Transparency](#council-democracy-and-transparency) — 102
- [💳 Budget, Finance & Procurement](#budget-finance-and-procurement) — 74
...
- [🌍 Environment, Climate & Monitoring](#environment-climate-and-monitoring) — 25
...
| Penticton — Zoning Dataset | Penticton · Municipal | Dataset | ArcGIS Feature Service of City of Penticton zoning boundaries and designations under the Official Community Plan. Download as CSV, GeoJSON, Shapefile, or KML, or query via REST API. Covers single-family, multi-family, commercial, industrial, and other zoning districts. | https://open.penticton.ca/datasets/d6c0def107a44da88fc2dab285ed459b/about |
...
| Name | Jurisdiction · Level | Type | Description | URL |
|---|---|---|---|---|
| Airdrie — Building and Trade Permits | Airdrie · Municipal | Dataset | Daily-updated feature service of all building and trade permits issued in Airdrie. Filter by permit type, application status, construction value, issue date, contractor name, and geocoded location. Downloadable as CSV, GeoJSON, Shapefile, or via ArcGIS REST API. | https://data-airdrie.opendata.arcgis.com/datasets/e658674f3860493da2ee2d55ff671bff/about |
...
| Name | Jurisdiction · Level | Type | Description | URL |
|---|---|---|---|---|
| Alberta Lobbyist Registry | Alberta · Provincial | Lobbyist registry | Search registered lobbyists, clients, and lobbying subjects in Alberta. Public read access to all filings under the Lobbyists Act. | https://www.albertalobbyistregistry.ca/apex/f?p=171:1 |
